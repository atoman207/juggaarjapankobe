...
export function HomePage(): React.ReactElement {
  return (
    <div className={styles.page}>
      ...
      {/* ============================================ */}
      {/* Secondary Contact Banner */}
      {/* ============================================ */}
      <section className={styles.secondaryContactBanner}>
        <div className={styles.container}>
          <div className={styles.contactBannerContent}>
            <div className={styles.contactBannerPhone}>
              <a href="tel:0789870902" className={styles.bannerPhoneNumber}>078-987-0902</a>
              <p className={styles.bannerBusinessHours}>10:00~19:00　定休日:日曜日</p>
            </div>
            <div className={styles.contactBannerButtons}>
              <RouterLink to="/contact" className={styles.bannerBtn}>
                お問い合わせはこちら
              </RouterLink>
              <a
                ...
                className={`${styles.bannerBtn} ${styles.bannerBtnOutline}`}
              >
                オフィシャルサイトへ
              </a>
            </div>
